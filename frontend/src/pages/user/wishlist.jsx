        ...
        >
            <div className="container-dfb">
                <div className="wishlist-header">
                    ...
                    <p>Lưu lại những cuốn sách bạn muốn mượn trong tương lai.</p>
                </div>

                {wishlistItems.length === 0 ? (
                    <div className="wishlist-empty">
                        <img src="/assets/library.avif" alt="Empty Wishlist" className="empty-img" onError={(e) => e.currentTarget.style.display = 'none'} />
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="wishlist-card-content">
                                        <div className="book-category">{book.category || "Chưa phân loại"}</div>
