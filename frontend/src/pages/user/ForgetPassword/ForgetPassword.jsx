...
function ForgotPassword() {
  ...
  return (
    <motion.div className="forgot-password-container" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.28 }}>
      <div className="forgot-password-card dfb-card">
