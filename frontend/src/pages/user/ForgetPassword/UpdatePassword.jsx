...
function ResetPassword() {
  ...
  return (
    <motion.div className="reset-password-container" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.28 }}>
      <div className="reset-password-card dfb-card">
