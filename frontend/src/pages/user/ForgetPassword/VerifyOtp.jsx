...
function VerifyOTP() {
  ...
  return (
    <motion.div className="verify-otp-container" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.28 }}>
      <div className="verify-otp-card dfb-card">
